...
/**
 * The PageViewCountWidget receives Matomo data and
 * displays the site visits from a given Matomo instance.
 */
class PageViewCountWidget extends AbstractExtensionsWidget
{
    protected $type = "actions";
    protected $title = AbstractExtensionsWidget::LANG_FILE . ':pageViewCountWidget.title';
    protected $description = AbstractExtensionsWidget::LANG_FILE . ':pageViewCountWidget.description';
    ...
    private function checkTitleIsRelative(): void
    {
        ...
        if (!$absoluteValues) {
            $this->title = \Mittwald\MatomoWidget\Widgets\AbstractExtensionsWidget::LANG_FILE . ':pageViewCountWidget.title.relative';
        }
    }
